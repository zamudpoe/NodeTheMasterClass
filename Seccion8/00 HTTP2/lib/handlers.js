      ...
      if (!err && userData) {
        ...
        if (hashedPassword == userData.hashedPassword) {
          ...
          _data.create('tokens',tokenId,tokenObject,function(err){
            ...
            /*
              NOTE: This is wrong way.

                var measurements = _performance.getEntriesByType('measure')
                measurements.forEach(function (measurement) {
                  debuglog('\x1b[33m%s : \x1b[36m%s\x1b[0m', measurement.name, measurement.duration)
                })
            */
        ...
        _data.read('users',userPhone,function(err,userData) {
          if(!err && userData) {
            ...
            if(userChecks.length < config.maxChecks){
              ...
              //  ezp Verify that the URL given has DNS entries ( and therefore can resolve )
              ...
              /* console.log('parsedUrl %o', parsedUrl) */
              // We going to try to resolve this dns
