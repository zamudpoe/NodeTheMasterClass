...
server.processHandlerResponse = function (res, method, trimmedPath, statusCode, payload, contentType) {
  ...
  /*
    Levantar el server con esta linea : NODE_DEBUG=server node index.js y hacemos GET a la ruta localhost:3000/examples/error
  */
  if (statusCode == 200) {
    debug('\x1b[32m%s\x1b[0m',method.toUpperCase()+' /'+trimmedPath+' '+statusCode)
  } else {
    debug('\x1b[5m\x1b[31m%s\x1b[0m',method.toUpperCase()+' /'+trimmedPath+' '+statusCode)
  }
