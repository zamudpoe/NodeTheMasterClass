          ...
          if (!err) {
            ...
            _logs.truncate(logId, function (err) {
              if (!err) {
                ...
                console.log("Error al truncar el archivo de registro")
              }
            });
          } else {
            console.log("Error al comprimir uno de los archivos de registro.", err)
          }
        })
      })
    } else {
      console.log('Error: no se pudo encontrar ningún registro para rotar')
    }
  })
}
