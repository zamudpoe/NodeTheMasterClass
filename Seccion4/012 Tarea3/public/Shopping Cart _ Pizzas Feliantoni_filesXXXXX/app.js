...
app.loadDataOnPage = function () {
  ...
  if (primaryClass == 'shoppingCart' ) {
    console.log('\nVista y proceso de carrito de compra en proceso!\n\n')
...
app.loadMenuListPage = function () {
  ...
  if (userIdentifier) {
    ...
    app.client.request (headers, 'menu', 'GET', undefined, undefined, function (statusCode, responsePayload) {
      if (statusCode == 200) {
        var menuList = typeof(responsePayload) == 'object' && responsePayload instanceof Array && responsePayload.length > 0 ? responsePayload : []
        ...
        if (menuList.length > 0) {
          ...
          menuList.forEach(function (elemento) {
            ...
            td1.classList.add('tdNombre')
            td2.classList.add('tdDesc')
            td3.classList.add('tdPrice')

            td0.innerHTML = elemento.id
            td1.innerHTML = elemento.name
            td2.innerHTML = elemento.displayName
            td3.innerHTML = elemento.price
          })
...
app.loadShoppingCartPage = function () {
  ...
  if (userIdentifier) {
    ...
    /* console.log('\theader: %o' , headers) */

    /*app.client.request(headers , 'menu', 'GET', undefined , undefined, function(statusCode , responsePayload) { console.log(responsePayload) } ) */
    app.client.request (headers, 'shoppingcart', 'GET', undefined, undefined, function (statusCode, responsePayload) {
      if (statusCode == 200) {
        var shoppingCartList = typeof (responsePayload) == 'object' && responsePayload instanceof Array && responsePayload.length > 0 ? responsePayload : []
...
debugger
          _data.read('menuitems', userIdentifier, function (err, data) {
            if (err) {
              console.log()
            }
          })
          ...
          /*
            shoppingCartList.forEach(function (elemento) {
              console.log(elemento)
